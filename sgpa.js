function calculate(){
    ...
    if (num1 < 0 || num1 > 100 || num2 < 0 || num2 > 100 || num3 < 0 || num3 > 100 || num4 < 0 || num4 > 100 || num5 < 0 || num5 > 100 || num6 < 0 || num6 > 100 || num7 < 0 || num7 > 100 || num8 < 0 || num8 > 100) {
...
if(calculate>=9){
    document.getElementById("result").value="Congratulations you got "+calculate+"SGPA";
}
else if(calculate>=8)
document.getElementById("result").value="Congratulations you got "+calculate+" SGPA";
